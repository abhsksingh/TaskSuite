    ...
    <div className="min-h-screen bg-[#0F1117] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[440px] animate-fade-slide-up">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-[#475569]">Create your account to get started</p>
        </div>
        ...
        <div className="bg-[#1A1D27] border border-[#2D3248] rounded-xl p-8 space-y-6">
          <div className="flex gap-4 border-b border-[#2D3248] pb-4">
            <Link to="/login" className="text-sm font-medium text-[#475569] hover:text-[#94A3B8] pb-4 -mb-4 transition-colors">Sign In</Link>
            <span className="text-sm font-medium text-[#F1F5F9] pb-4 border-b-2 border-[#6366F1] -mb-4">Sign Up</span>
          </div>

          {error && (
            <div className="bg-[#450A0A] border border-[#EF4444]/30 text-[#EF4444] text-sm px-4 py-3 rounded-lg">{error}</div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <IconUser size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#475569]" />
            ...
            <button type="submit" disabled={loading}
              className="w-full h-10 bg-[#6366F1] text-white rounded-lg text-sm font-medium hover:bg-[#4F46E5] transition-colors active:scale-[0.97] disabled:opacity-50">
